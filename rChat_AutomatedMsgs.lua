...
function automatedMessagesList:New(control)
	...
	local AutomatedMessagesSorterKeys = {
 	...
 	o.masterList = {}
 	ZO_ScrollList_AddDataType(o.list, 1, "rChatXMLAutoMsgRowTemplate", 32, function(control, data) o:SetupEntry(control, data) end)
 	ZO_ScrollList_EnableHighlight(o.list, "ZO_ThinListHighlight")
 	o.sortFunction = function(listEntry1, listEntry2) return ZO_TableOrderingFunction(listEntry1.data, listEntry2.data, o.currentSortKey, AutomatedMessagesSorterKeys, o.currentSortOrder) end
